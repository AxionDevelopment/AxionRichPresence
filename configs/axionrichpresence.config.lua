...
AxionRichPresenceConfig.AppID = "APP_ID_HERE"
...
AxionRichPresenceConfig.RichText = "{player} is playing on SERVER NAME | {playercount} of {maxplayers} players"
